# slowloris_lab/advanced_slowloris.py
...
class SocketWorker(threading.Thread):
    ...
    """
    def __init__(self, target_ip, header_size, attack_state):
        super().__init__()
    ...
    def run(self):
        ...
        try:
            ...
            self.sock.connect((self.target_ip, 80))
    ...
    try:
        ...
        while not stop_event.is_set():
            ...
            while len(threads) < args.connections:
                worker = SocketWorker(args.hostname, args.header_size, attack_state)
                worker.start()
