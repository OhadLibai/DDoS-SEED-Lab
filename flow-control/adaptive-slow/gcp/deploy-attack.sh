...
# adaptive-slow Attack Deployment
# Deploys Advanced Adaptive Slow attack to existing GCP infrastructure
...
echo -e "${BLUE}🎯 Deploying adaptive-slow Attack${NC}"
...
echo -e "${GREEN}Deploying Advanced Adaptive Slow attack lab...${NC}"
...
echo ""
echo -e "${GREEN}🎉 adaptive-slow deployed successfully!${NC}"
echo ""
